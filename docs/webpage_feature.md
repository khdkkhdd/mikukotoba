...
> ミク言葉 - YouTube·Twitter(X) 이외의 일반 웹사이트에 대한 번역 기능의 사용자 관점 기능 명세
> 작성일: 2026-02-19
...
| **ミク言葉 삽입 요소** | 이미 번역이 삽입된 요소 (`data-jp-translation`, `data-jp-processed` 속성) |
...
- ミク言葉가 삽입한 번역 요소는 자동으로 무시하여 무한 루프를 방지한다.
